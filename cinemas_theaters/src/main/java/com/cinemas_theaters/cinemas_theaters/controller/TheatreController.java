...
public class TheatreController {
    ...
    public ResponseEntity<?> getAllTheatres(){
        ...
        for (Theatre t: theatres){
            theatreDTOS.add(new TheatreDTO(t.getId(), t.getName(),  t.getAddress(), t.getDescription(),t.getRate()));
        }
    ...
    public ResponseEntity findByName(@PathVariable final String name){
        ...
        if (theatre != null){
            TheatreDTO theatreDTO = new TheatreDTO(theatre.getId(),theatre.getName(),theatre.getAddress(),theatre.getDescription(), theatre.getRate());
