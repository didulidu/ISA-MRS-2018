...
function showRepertoire(){
    ...
    $('#nav-repertoire').append("<div class='cards' id = 'shows' style='display: flex;flex-wrap: wrap;'>");
    addTheaterAdminWidgets();
    if(showsList.length){
        ...
        showsList.forEach(function(show){
            ...
            var Kartica = "<div class='card' style='width: 20%;height:300px' id='"+show["id"]+"'>"
